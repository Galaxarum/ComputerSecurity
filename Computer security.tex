...
Packet filter, plus keep track of the TCP state machine. This allows to track connections, but brings performance issues (the \# of open connections becomes a complexity variable)
